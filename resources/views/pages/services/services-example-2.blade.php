<!DOCTYPE html> <html> <head> <title>Jasa & Produk</title> <meta charset="utf-8"> <meta name="viewport"
    content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"> <link
    href="{{asset('layout/styles/layout.css')}}" rel="stylesheet" type="text/css" media="all">
                ...
                <main class="hoc container clear">
                    ...
                    <div class="group btmspace-50 left">
                        <div class="three_quarter first">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni qui minima alias a ratione laudantium corporis, mollitia cumque consequuntur dolor.</p>
                        </div>
                    ...
                    <ul class="nospace clear services content_card_2">
                        <li class="one_quarter first">
                                ...
                                <hr>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus voluptatem numquam voluptates esse facilis aperiam aspernatur sunt quia, odit enim?</p>
                        </li>
