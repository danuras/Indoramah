...
<body id="top">
    ...
    <div class="wrapper row3" id="blog">
        <section class="hoc container clear">
            ...
            <div class="latest">
                <article class="clear">
                    <div class="one_half first"><a class="iblock borderedbox inspace-10" href="#"><img src="{{asset('images/demo/540x333.png')}}" alt=""></a></div>
                    <div class="one_half">
                        <h3 class="heading">Elementum scelerisque nisi id sollicitudin tellus vivamus id convallis tellus</h3>
                        <ul class="nospace meta">
                            <li><time datetime="2045-04-06">6<sup>th</sup> April 2045</time></li>
                        ...
                        <footer>
                            <a class="btn" href="https://www.danforblog.com/pengertian-dan-cara-membuat-blog-dummy/">Read More</a>
                        </footer>
                    </div>
                </article>
                <article class="clear">
                    <div class="one_half first">
                        ...
                        <ul class="nospace meta">
                            <li><time datetime="2045-04-05">5<sup>th</sup> April 2045</time></li>
                            <li>by <a href="https://www.danforblog.com/author/danforblog/">Admin</a></li>
                        </ul>
                    ...
                    <div class="one_half">
                        <a class="iblock borderedbox inspace-10" href="#">
                            <img src="{{asset('images/demo/540x333.png')}}" alt="">
                        </a>
                    </div>
                </article>
            </div>
