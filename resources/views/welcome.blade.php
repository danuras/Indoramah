...
<div class="carousel slide row3" data-ride="carousel" id = "testimonies">
    <!-- Indicators -->
    ...
    <footer id="footer" class="hoc clear">
        ...
        <div class="one_quarter">
            ...
            <div class="group btmspace-10 demo">
                <div class="one_third first box_social_media"><i class="fa fa-facebook" aria-hidden="true"></i></div>
            ...
            <div class="group btmspace-10 demo">
                <div class="one_third first box_social_media"><i class="fa fa-instagram" aria-hidden="true"></i></div>
